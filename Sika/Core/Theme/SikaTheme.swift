...
enum SikaTheme {
    enum Color {
        ...
        static let background = SwiftUI.Color(
            light: SwiftUI.Color(hex: 0xFBF7EE),
            dark: SwiftUI.Color(hex: 0x0E1A2E)
        )
        static let foreground = SwiftUI.Color(
            light: SwiftUI.Color(hex: 0x0E1A2E),
            dark: SwiftUI.Color(hex: 0xF8ECC2)
        )
        static let card = SwiftUI.Color(
            light: SwiftUI.Color(hex: 0xFFFFFF),
            dark: SwiftUI.Color(hex: 0x162540)
        )

        // Primary / Accent (gold stays constant — brand identity preserved across modes)
        static let primary = SwiftUI.Color(hex: 0xD4A017)
        static let primaryForeground = SwiftUI.Color(hex: 0x0E1A2E)

        // Secondary / Muted (adaptive)
        static let secondary = SwiftUI.Color(
            light: SwiftUI.Color(hex: 0xF1EFE6),
            dark: SwiftUI.Color(hex: 0x1E2F47)
        )
        static let muted = SwiftUI.Color(
            light: SwiftUI.Color(hex: 0xF1EFE6),
            dark: SwiftUI.Color(hex: 0x1E2F47)
        )
        static let mutedForeground = SwiftUI.Color(
            light: SwiftUI.Color(hex: 0x6B7A8D),
            dark: SwiftUI.Color(hex: 0x8A9BB5)
        )
        ...
        static let placeholderText = SwiftUI.Color(
            light: SwiftUI.Color(hex: 0x525E70),
            dark: SwiftUI.Color(hex: 0x8A9BB5)
        )

        // Border (adaptive)
        static let border = SwiftUI.Color(
            light: SwiftUI.Color(hex: 0xE2DCCF),
            dark: SwiftUI.Color(hex: 0x1E3050)
        )

        // Destructive (constant — brand identity)
        static let destructive = SwiftUI.Color(hex: 0xF43F5E)

        // Sika brand palette (constant — these ARE the brand)
        ...
        // Bucket colors (constant — brand-significant)
